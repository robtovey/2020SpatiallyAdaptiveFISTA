...
\begin{document}
	...
	\end{equation}
	is exactly computable for all $\varf1\in\F H$ and all $\tilde{\spcf0}\in\{\spcf0^n\}_{n=0}^\infty$. \edit{}{We denote the orthogonal projection operators $\tens{\Pi}_n\colon\F H\to\spcf0^n$ such that $\tens{\Pi}_n\varf0-\varf0 \perp \varf1$ for all $\varf0\in\F H$, $\varf1\in\spcf0^n$. \todo{Finite dimensional?}}
