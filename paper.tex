...
\begin{document}
	...
	\edit{First we use the strong convexity of $\op{E}^*$}{Recall that $\nabla\op{f}$ is 1-Lipschitz if and only if $\op{f}^*$ is 1-strongly convex. \todo{Is there a reference for this? I can't find it in Rockafellar.} Therefore}, if $\vars2_0\vvard0_n$ and $\vvard0^*$ are both dual-feasible, then
	\begin{equation}
